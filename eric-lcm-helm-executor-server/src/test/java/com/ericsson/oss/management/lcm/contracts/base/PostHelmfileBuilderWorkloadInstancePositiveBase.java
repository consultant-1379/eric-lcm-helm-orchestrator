...
public class PostHelmfileBuilderWorkloadInstancePositiveBase {
    @InjectMocks
    ...
    public void setup() {
        ...
        when(operationCoordinatorService.instantiate(any(WorkloadInstanceWithChartsRequestDto.class), any(), any())).thenReturn(
                workloadInstanceDto);
