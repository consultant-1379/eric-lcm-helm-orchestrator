...
Contract.make {
    description("""
Represents a failure scenario for wrong formed request when getting workload instances with pagination


given:
  client requests workload instances with an invalid sort
when:
