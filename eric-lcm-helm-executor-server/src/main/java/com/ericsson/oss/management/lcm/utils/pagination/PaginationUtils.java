...
public final class PaginationUtils {
    ...
    public static Pageable createPageable(Integer pageNumber, Integer pageSize, List<String> sortQueries,
                                          Set<String> validSortColumns, Pageable defaults) {
        ...
        if (sortQueries == null || sortQueries.isEmpty()) {
            ...
            sort = parseSort(sortQueries, validSortColumns);
        }
        return CustomPageRequest.of(page, size, sort);
    }

    public static Sort parseSort(List<String> sortQueryList, Set<String> validSortColumns) {
