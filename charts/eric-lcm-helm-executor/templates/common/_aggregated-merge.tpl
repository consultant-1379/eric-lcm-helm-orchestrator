...
{{- define "eric-lcm-helm-executor.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-lcm-helm-executor.mergeAnnotations" -}}
  {{- include "eric-lcm-helm-executor.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) | trim}}
{{- end -}}

{{- define "eric-lcm-helm-executor.mergeLabels" -}}
  {{- include "eric-lcm-helm-executor.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) | trim }}
{{- end -}}
