...
{{- define "eric-ran-rad-rce-base.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-ran-rad-rce-base.mergeAnnotations" -}}
  {{- include "eric-ran-rad-rce-base.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-ran-rad-rce-base.mergeLabels" -}}
  {{- include "eric-ran-rad-rce-base.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
